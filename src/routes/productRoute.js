...
const {addProduct, getProducts, getProductDetails, getProductOnHighlyDiscount, getProductsUnderOneThousand, getProductsOnLimitedTimeDeal, productReview, deleteProductReview, updateProductReview}=require("../controllers/productController.js");
